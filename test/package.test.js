...
`;
    ...
    run(process.execPath,[path.join(root,'node_modules/typescript/bin/tsc'),'--strict','--noEmit','--target','es2022','--module','nodenext','--moduleResolution','nodenext','--typeRoots',path.join(root,'node_modules/@types'),'--types','node','consumer.cts','consumer.mts']);
